...
&kp PIPE2,         &kp LS(PIPE2),     &kp RA(N8),        &kp RA(N9),        &kp PIPE2,         &kp RA(N7),        &kp LS(SQT),       &kp LS(LBKT),      &kp LS(SEMI),      &kp MINUS,            \
&kp PIPE,          &kp LS(N2),        &kp ASTRK,         &kp LPAR,          &kp RA(Q),         &kp LS(ß),         U_MT(LSHFT, SQT),  U_MT(LCTRL, LBKT), U_MT(LALT, SEMI),  U_MT(LGUI, MINUS),    \
&kp PLUS,          &kp DLLR,          &kp RA(N7),        &kp RA(N0),        &kp BSLH,          U_NA,              &u_to_U_SYM,       &u_to_U_MOUSE,     &kp AMPERSAND,     &kp PERCENT,          \
