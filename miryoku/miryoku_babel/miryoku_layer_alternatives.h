...
&kp SEMI,          &kp N4,            &kp N5,            &kp N6,            &kp RBRC,          U_NA,              &kp LSHFT,         &kp LCTRL,         &kp LALT,          &kp LGUI,          \
&kp GRAVE,         &kp N1,            &kp N2,            &kp N3,            &kp KP_DIVIDE,     U_NA,              &u_to_U_NUM,       &u_to_U_NAV,       &kp RALT,          U_NA,              \
U_NP,              U_NP,              &kp KP_MINUS,      &kp N0,            &kp KP_PLUS,       U_NA,              U_N  A,              U_NA,              U_NP,              U_NP
...
&kp PIPE2,         &kp LS(PIPE2),     &kp RA(N8),        &kp RA(N9),        &kp PIPE2,         U_NA,              &kp LS(SQT),       &kp LS(LBKT),      &kp LS(SEMI),      LS(MINUS),         \
