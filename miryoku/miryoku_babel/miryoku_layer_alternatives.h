...
U_BOOT,            &u_to_U_TAP,       &u_to_U_EXTRA,     &u_to_U_BASE,      U_NA,              U_RGB_TOG,         U_RGB_EFF,         &kp C_VOL_UP,      &bt BT_CLR_ALL,    &bt BT_CLR,        \
...
&kp MINUS,         &kp N7,            &kp N8,            &kp N9,            &kp RBRC,          U_NA,              &u_to_U_BASE,      &u_to_U_EXTRA,     &u_to_U_TAP,       U_BOOT,            \
&kp BSLH,          &kp N4,            &kp N5,            &kp N6,            &kp RBKT,          U_NA,              &kp LSHFT,         &kp LCTRL,         &kp LALT,          &kp LGUI,          \
&kp GRAVE,         &kp N1,            &kp N2,            &kp N3,            &kp SLASH,         U_NA,              &u_to_U_NUM,       &u_to_U_NAV,       &kp RALT,          U_NA,              \
U_NP,              U_NP,              &kp DOT,           &kp COMMA,         &kp N0,            U_NA,              U_NA,              U_NA,              U_NP,              U_NP
...
&kp LS(N3),        &kp LS(N5),        &kp RA(N8),        &kp RA(N9),        &kp NON_US_BACKSLASH,&kp RA(NON_US_BACKSLASH),  &kp LS(SQT), &kp LS(LBKT),      &kp LS(SEMI),      &kp MINUS,            \
&kp RA(RBKT),      &kp LS(N2),        &kp ASTRK,         &kp LPAR,          &kp RA(Q),         &kp RA(MINUS),     U_MT(LSHFT, SQT),  U_MT(LCTRL, LBKT), U_MT(LALT, SEMI),  U_MT(LGUI, MINUS),    \
&kp PLUS,          &kp DLLR,          &kp RA(N7),        &kp RA(N0),        &kp BSLH,          &kp LS(N6),        &kp PLUS,          &kp LS(BSLH),      &kp AMPERSAND,     &kp PERCENT,          \
